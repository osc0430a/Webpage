...
<%
	...
	String qry = "select hits, title, name, content, to_char(rdate,'yyyy/mm/dd') as rdate from board1 where unq="+unq;
	...
	String qry2 = "update board1 set hits='"+hits+"' where unq = '"+unq+"'";
...
<body>
	...
	<div class="section" >
		...
		<form name="frm" method="post" action="boardModify.jsp?unq=<%=unq%>">
		...
		<div style="position:relative;
			...
			<table class="table1" style="margin-left:5px;margin-top:5px;">
				...
				<caption style="font-size:20px">글 상세 보기</caption>
		...
		<div style="width:600px;text-align:center;margin-top:5px">
			...
			<button type="reset" onclick="location='boardList.jsp'">돌아가기</button>				
