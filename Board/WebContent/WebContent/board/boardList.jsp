...
// total 개수
String qry1 = "select count(*) total from board1";
...
<body>
	...
	<div class="section" >
		...
		<div style="width:600px;position:relative;left:50px;text-align:right">
			...
			<button type="button" style="float:right" onclick="location='boardWrite.jsp'">글쓰기</button>		
			
			<form name="frm2" method="post" action="boardList.jsp">
		...
		<div class="divTable1">
			...
			%>
				...
				<tr>
					...
					<td class="td1"><a href="boardDetail.jsp?unq=<%=unq%>"><%=title %></a></td>
		...
		<div style="width:600px;text-align:center;position:relative;left:50px;top:20px">
				...
				%>
					...
					<a href="boardList.jsp?v_page=<%=i%>" style="text-size:5px"><%=i %></a>
